      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-purple-100 dark:bg-purple-900/30 hover:bg-purple-200 dark:hover:bg-purple-800/40 text-purple-700 dark:text-purple-300 rounded-full transition-all text-xs font-medium flex items-center gap-1 hover:scale-105 hover:shadow-sm"
