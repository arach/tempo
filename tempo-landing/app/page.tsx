...
import { ArrowRight, Sparkles, Heart, Quote, Github, ExternalLink } from "lucide-react";
      ...
      <header className="border-b border-border/50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a 
              href="https://github.com/arach/tempo" 
              target="_blank" 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Button size="lg" className="text-base px-8 py-4 rounded-xl font-semibold 
                shadow-lg hover:shadow-xl transition-all duration-200 group gap-2
            ...
            <a 
              ...
              rel="noopener noreferrer"
            >
              <Button variant="outline" size="lg" className="text-base px-8 py-4 rounded-xl font-semibold 
                shadow-lg hover:shadow-xl transition-all duration-200 group gap-2">
                <Github className="h-4 w-4" />
